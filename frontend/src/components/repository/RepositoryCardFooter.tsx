  ...
  return (
    <div className="flex flex-col grow justify-end pl-2">
      ...
      <div className="flex flex-row w-full">
        ...
        <div className="text-md font-medium md:text-2xl">{language}</div>
      </div>
      ...
      <div className="flex flex-row justify-between w-full">
        ...
        <div className="flex flex-row">
          ...
          <div className="text-md font-medium md:text-2xl">{stargazers_count}</div>
        </div>

        <div className="flex md:flex-row pr-2">
